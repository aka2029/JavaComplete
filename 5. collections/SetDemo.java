...
//		Set<String> set1 = new HashSet<>(); // refer to objects by their interface
//		set1.add("a");
//		set1.add("b");
//		set1.add("a");
//						
//		System.out.println("set1: " +  set1);	//hashset doesn't allow duplicates
//		
//		Book book1 = new Book("Walden", "Henry Thoreau", 1854);
//		Book book2 = new Book("Walden", "Henry Thoreau", 1854);
//		//book1 and 2 are having diff hashcode but should have same bec are duplicates
//		//so, now overwrite the hashcode method
//		//and equals method also has to be overwritten
//		Set<Book> set2 = new HashSet<>();
//		set2.add(book1);
//		set2.add(book2);
//		System.out.println("set2: " +  set2); //this was not readable because it was
//									//reading the object references so we has to 
...
//exploring navigable set method
